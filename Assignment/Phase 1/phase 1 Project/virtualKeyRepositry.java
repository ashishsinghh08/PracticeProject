...
public class virtualKeyRepositry {
    public static void main(String[] args)  {
        File folder = new File("C:\\Users\\ashis\\OneDrive\\Desktop\\project");
        ...
        while(true){
            ...
            switch(choice)
            {
                ...
                case 2:
                    Boolean temp = true;
                    while(temp) {
                        System.out.println("Operation 1 :- To Add a file in the existing Directory");
                        System.out.println("Operation 2 :- To Delete a file from the existing Directory. ");
                        System.out.println("Operation 3 :- To Search a user specified file from the Directory");
                        System.out.println("Operation 4 :- Back to the previous menu");
                        System.out.println("Operation 5  :- Terminate Program");
                        ...
                        switch (choice2) {
                            case 1:
                                File f = new File("C:\\Users\\ashis\\OneDrive\\Desktop\\project");
